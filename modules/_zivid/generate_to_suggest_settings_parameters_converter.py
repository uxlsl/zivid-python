...
def start_traverse():
    from _zivid._zivid.capture_assistant import (
        SuggestSettingsParameters as InternalSuggestSettingsParameters,
    )

    data_model = _recursion(InternalSuggestSettingsParameters, indentation_level=0)
