...
def to_internal_frame_info(frame_info):
    ...
    def _to_internal_software_version(software_version):
    ...
    global to_internal_software_version
    to_internal_software_version = _to_internal_software_version

    internal_frame_info.time_stamp = _zivid.FrameInfo.TimeStamp(frame_info.time_stamp)

    internal_frame_info.software_version = _to_internal_software_version(
